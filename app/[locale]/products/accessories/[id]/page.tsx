...
export default function AccessoryDetailPage({ params }: { params: { id: string } }) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/products/accessories" className="text-green-600 hover:text-green-700 font-medium">
            ← Back to Accessories
          </Link>
        </div>
      </div>
  ...
  const handleAddToCart = () => {
    addToCart({
      ...
      name: accessory.name,
      price: typeof accessory.price === 'number' ? accessory.price : parseInt(String(accessory.price).replace(/,/g, '')),
      quantity: quantity,
      image: accessory.image
    });
  };

  const images = [accessory.image, "/products/acc2.jpg", "/products/acc3.jpg"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <Link href="/products/accessories" className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-medium mb-8">
